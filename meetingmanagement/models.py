...
class Proyecto(models.Model):
    ...
    descripcion_proyecto = models.TextField("Descripción", max_length=600)
...
class Usuario_Proyecto(models.Model):
    ...
    def __str__(self):
        return 'Usuario: '+self.usuario+'. Proyecto: '+self.proyecto

class Tema(models.Model):
    acta_tema = models.ForeignKey(Acta, verbose_name="acta del tema")
    titulo_tema = models.CharField(max_length=50)
    descripcion_tema = models.TextField("Descripción del Tema", max_length=600)
    #numeracion_tema = models.IntegerField()
...
class Elemento(models.Model):
    ...
    titulo_elemento = models.CharField("Titulo", max_length=50)
    descripcion_elemento = models.CharField("Descripcion", max_length=600)
